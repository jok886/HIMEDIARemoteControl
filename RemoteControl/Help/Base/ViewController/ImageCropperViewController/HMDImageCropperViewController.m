//
//  HMDImageCropperViewController.m
//  RemoteControl
//
...
@interface HMDImageCropperViewController ()
...
@implementation HMDImageCropperViewController
...
- (void)initView {
    ...
    self.showImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, width, width)];
