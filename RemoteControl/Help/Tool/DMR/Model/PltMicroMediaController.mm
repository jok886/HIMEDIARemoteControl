...
/*----------------------------------------------------------------------
 ...
 +---------------------------------------------------------------------*/
PLT_MicroMediaController::PLT_MicroMediaController(PLT_CtrlPointReference& ctrlPoint,HMDDMRControl * delegateWrapper) :
...
{
    NSMutableArray<HMDEventParamsResponse *> *stateArray = [NSMutableArray array];
    ...
    while (var) {
        ...
        HMDEventParamsResponse * state = [[HMDEventParamsResponse alloc] initWithDeviceUUID:deviceUUID ServiceID:serviceID EventName:eventName EventValue:eventValue];
                                   ...
                                   void*                    userdata)
{
    ...
    if(m_Target.delegate && [m_Target.delegate respondsToSelector:@selector(getCurrentAVTransportActionResponse:)])
    {
        ...
        HMDCurrentAVTransportActionResponse *capsule = [[HMDCurrentAVTransportActionResponse alloc]initWithResult:result DeviceUUID:deviceUUID Actions:actionArr UserData: (__bridge id)userdata];
                         ...
                         void*                    userdata)
{
    if(m_Target.delegate && [m_Target.delegate respondsToSelector:@selector(getTransportInfoResponse:)])
    {
        ...
        HMDTransportInfoResponse *capsule = [[HMDTransportInfoResponse alloc]initWithResult:result DeviceUUID:deviceUUID UserData: (__bridge id)userdata];
             ...
             void*                    userdata)
{
    if(m_Target.delegate && [m_Target.delegate respondsToSelector:@selector(nextResponse:)])
    {
        ...
        HMDEventResultResponse *capsule = [[HMDEventResultResponse alloc]initWithResult:result DeviceUUID:deviceUUID UserData: (__bridge id)userdata];
                  ...
                  void*                    userdata)
{
    if(m_Target.delegate && [m_Target.delegate respondsToSelector:@selector(getVolumeResponse:)])
    {
        ...
        HMDVolumResponse * capsule = [[HMDVolumResponse alloc] initWithResult:result DeviceUUID:deviceUUID UserData:(__bridge id)userdata Channel:cnl Volume:volume];
