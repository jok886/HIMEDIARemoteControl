...
{
    NSMutableArray<HMDRenderDeviceModel *> * renderArray = [NSMutableArray array];
    ...
    while (entry) {
        HMDRenderDeviceModel * renderModel = [[HMDRenderDeviceModel alloc] init];
